...
`,ft="0.5.0";console.info(`%c HA-RADIO-CARD %c ${ft} `,"color:#fff;background:#03a9f4","color:#03a9f4;background:#fff");const xt=t=>B`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d=${t} />
      ...
      <ha-card style=${"--rad-eq-state:"+(t?"running":"paused")}>
        ...
        <div class="top">
          ...
          ${this._showEqualizer?this._renderEqualizer():F}
        </div>

        ${!1===this._config.show_ticker?F:B`
              <div class="ticker">
        ...
        <div class="transport">
          ...
          <div class="vol">
            ...
            <span class="volicon" aria-hidden="true">${kt}</span>
            <input
              type="range"
              min="0"
              max="1"
        ...
        ${!1===this._config.show_target_picker?F:B`
              <div class="foot">
                <span class="foot-icon" aria-hidden="true">${$t}</span>
                <select
                  class="ghost"
                  aria-label="Target"
    ...
    `],t([ht({attribute:!1})],At.prototype,"hass",void 0),t([pt()],At.prototype,"_config",void 0),t([pt()],At.prototype,"_radio",void 0),t([pt()],At.prototype,"_target",void 0),t([pt()],At.prototype,"_volume",void 0),t([pt()],At.prototype,"_error",void 0),t([pt()],At.prototype,"_tickerOverflows",void 0),At=t([(t=>(e,a)=>{void 0!==a?a.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("ha-radio-card")],At);const Et=window;Et.customCards=Et.customCards||[],Et.customCards.push({type:"ha-radio-card",name:"HA Radio",description:"Internet radio with themed equalizer (companion to the HA Radio integration)",preview:!0,documentationURL:"https://github.com/padlefot/ha_radio_card",getEntitySuggestion:(t,e)=>"select.ha_radio_station"===e?{config:{type:"custom:ha-radio-card"}}:null});export{At as HaRadioCard};
